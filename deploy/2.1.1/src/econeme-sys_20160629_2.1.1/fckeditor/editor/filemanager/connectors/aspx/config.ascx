...
<script runat="server">
	...
	private bool CheckAuthentication()
	{
		...
		User userLogged = (User)Session["user-logged"];
		...
		if(userLogged!=null)
		{
			...
			log.usr= "system";
			log.msg = "test fckeditor: authorized="+authorized+" - user logged: "+userLogged.username;
			log.type = "debug";
	...
	public override void SetConfig()
	{
		...
		UserFilesPath = "/public/upload/wysiwyg_editor/";
