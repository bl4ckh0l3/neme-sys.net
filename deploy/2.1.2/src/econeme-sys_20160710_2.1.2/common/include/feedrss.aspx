...
{	
	...
	builder = new StringBuilder(Request.Url.Scheme).Append("://").Append(Request.Url.Host);
			...
			if(content.categories != null){
				foreach(ContentCategory cc in content.categories){
					...
					if(template != null){				
						...
						detailLink = MenuService.resolvePageHrefUrl(Request.Url.Scheme+"://", modelPageNum, lang.currentLangCode, langHasSubDomainActive, langUrlSubdomain, category, template, true);
						break;
