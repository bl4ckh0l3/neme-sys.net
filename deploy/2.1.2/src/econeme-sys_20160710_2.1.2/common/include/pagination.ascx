<%@control Language="c#" description="pagination-control" className="PaginationControl"%>
...
protected void set() 
{
	...
	_currentLangCode = MultiLanguageService.getLangCode((string)Session["lang-code"], Request["lang_code"], Convert.ToBoolean(Convert.ToInt32(configService.get("use_locale").value)));
