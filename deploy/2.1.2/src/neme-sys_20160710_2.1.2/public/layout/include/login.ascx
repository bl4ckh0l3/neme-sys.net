...
<div id="warp">
	...
	<div id="container">    	
		...
		<div id="content-center">
			...
			<form name="login" method="post" action="/login.aspx" onSubmit="return sendForm();">
			...
			<form name="lost_pwd" method="post" action="/login.aspx" onSubmit="return sendFormLostPwd();">
			...
			<%=lang.getTranslated("frontend.login.label.compile_module")%>&nbsp;<a href="/area_user/account.aspx"><%=lang.getTranslated("frontend.login.label.registration")%></a>
