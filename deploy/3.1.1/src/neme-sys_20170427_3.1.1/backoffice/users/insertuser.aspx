...
<!--nsys-usrins3--><input type="hidden" value="<%=groupid%>" name="user_group"><input type="hidden" value="<%=user.discount.ToString()%>" name="sconto"><!---nsys-usrins3-->
			<tr>
			<td width="300">	 		  
