...
{
	public class ContentFieldsValue : IComparable<ContentFieldsValue>
	{	
		private int _idParentField;
		private string _value;
		private int _sorting;
		
		public ContentFieldsValue(){}
		...
		public virtual int CompareTo(ContentFieldsValue other)
		{
		...
		{
			ContentFieldsValue other = obj as ContentFieldsValue;
			if (other == null)
				return false;
		...
		public virtual string ToString() {
			StringBuilder builder = new StringBuilder("ContentFieldsValue: ")
