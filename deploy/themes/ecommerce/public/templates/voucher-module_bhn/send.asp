...
function controllaCampiMail(){	
	...
	if(document.form_send_mail.citta.value == ""){
		alert("<%=lang.getTranslated("frontend.template_contatti.js.alert.insert_city")%>");
		document.form_send_mail.citta.focus();
		return false;
	}		
...
<div id="warp">
	...
	<div id="container">	
		...
		<div id="content-center">
			...
			<ul>
			<li><span><%=lang.getTranslated("frontend.template_voucher.label.testo_mail")%></span></li>
