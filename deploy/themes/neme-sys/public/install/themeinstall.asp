...
if(request("apply") = "true") then	
	...
	objDict.add "homepage_nemesys","" 
	objDict.add "community_nemesys","" 
	objDict.add "features_nemesys","" 
	objDict.add "search","" 
	objDict.add "newsletter","" 
	objDict.add "contactus_nemesys",""
	objDict.add "download_nemesys",""
...
<div id="container">
	...
	<div id="header" class="bg_nemesys">
		<div class="header_navbar">
			...
			<div class="div_login">
				<a href="<%=Application("baseroot")&"/login.asp"%>">Login</a> Or <a href="<%=Application("baseroot")&"/area_user/manageUser.asp"%>">Registration</a>
			</div>
		</div>		
	</div>
	<!-- header fine -->
