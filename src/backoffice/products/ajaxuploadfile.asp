...
call objLogger.write("clreturnimgpath: "&Upload.Form("clreturnimgpath"), "system", "debug")
call objLogger.write("clreturnimgpathproductfield27: "&Upload.Form("clreturnimgpathproductfield27"), "system", "debug")
call objLogger.write("clreturnimgpathproductfield19: "&Upload.Form("clreturnimgpathproductfield19"), "system", "debug")
call objLogger.write("clreturnimgpathproductfield28: "&Upload.Form("clreturnimgpathproductfield28"), "system", "debug")
call objLogger.write("clfilename: "&Upload.Form("clfilename"), "system", "debug")
call objLogger.write("clfilenameproductfield27: "&Upload.Form("clfilenameproductfield27"), "system", "debug")
call objLogger.write("clfilenameproductfield19: "&Upload.Form("clfilenameproductfield19"), "system", "debug")
call objLogger.write("clfilenameproductfield28: "&Upload.Form("clfilenameproductfield28"), "system", "debug")
...
call objLogger.write("BO product field upload file - Err.description: "&Err.description, "system", "debug")
end if	
