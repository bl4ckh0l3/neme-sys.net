...
protected void Page_Load(Object sender, EventArgs e)
{
	...
	{		
		...
		if(original.attachments != null && original.attachments.Count>0){
			CommonService.directoryCopy(HttpContext.Current.Server.MapPath("~/public/upload/files/products/"+original.id), HttpContext.Current.Server.MapPath("~/public/upload/files/products/"+newproduct.id), true, false);
		}
