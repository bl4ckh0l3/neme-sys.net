...
protected void Page_Load(Object sender, EventArgs e)
{
	...
	int id_vote = Convert.ToInt32(Request["id_vote"]);

	try
	{
		Preference preference = preferencerep.getById(id_vote);
		preference.active = true;
		preferencerep.update(preference);
		msg.Text = lang.getTranslated("frontend.popup.label.vote_posted");
	}catch(Exception ex){
		msg.Text = ex.Message;
	}	
}
