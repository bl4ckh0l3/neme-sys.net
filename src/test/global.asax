...
<script runat=server>
	...
	protected void Application_Start(object sender, EventArgs e)
	{
		...
		*/
		/*
		// non funziona - il timer non intercetta il metodo OnTimedEvent e non scatena mai la callback
		
		// ************* manage quantity rotation Task
		...
		log = new Logger();
		log.usr= "system";
		log.msg = "- aTimer: "+aTimer.ToString()+"<br>- isEnabled: "+aTimer.Enabled+"<br>- aTimer.AutoReset: "+aTimer.AutoReset;
		log.type = "debug";
		log.date = DateTime.Now;
		lrep.write(log);	
		*/
	...
	{
		ConfigurationService cf = new ConfigurationService();
		StringBuilder builder;
		Logger log;

		UriBuilder builder0 = new UriBuilder(cf.get("server_name").value);
		...
		UriBuilder builder1 = new UriBuilder(cf.get("server_name").value);
